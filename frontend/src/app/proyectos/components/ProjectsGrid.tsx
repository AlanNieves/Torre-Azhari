        ...
        <div className="grid gap-8 lg:gap-12">
          {projects.map((project, index) => (
            <motion.article
              ...
              viewport={{ once: true }}
              transition={{ duration: 0.6 }}
              className="group relative grid gap-6 overflow-hidden rounded-2xl bg-[#252525] lg:grid-cols-2"
            >
              {/* Image Container */}
              ...
              <div className="flex flex-col justify-center p-8 lg:p-12">
                <h3 className="mb-3 font-serif text-3xl font-light text-white lg:text-4xl">
                  {project.title}
                </h3>
