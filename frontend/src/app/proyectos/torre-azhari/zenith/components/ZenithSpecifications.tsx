...
const specs = [
  { icon: Maximize2,  label: "Área de departamento",      value: "172.60 m²" },
  { icon: Sun,        label: "Área de terraza panorámica", value: "14.80 m²" },
  { icon: DollarSign, label: "Costo x m²",                value: "$48,500" },
  { icon: BedDouble,  label: "Recámaras",                  value: "3" },
  { icon: Bath,       label: "Baños",                      value: "3" },
  { icon: Car,        label: "Cajones de estacionamiento", value: "3" },
];

export default function ZenithSpecifications() {
  return (
        ...
        <div className="grid gap-16 lg:grid-cols-2 lg:gap-24">
          ...
          >
            ...
            <p className="mt-6 max-w-md text-base leading-relaxed text-white/60">
              El nivel más alto de Torre Azhari. Un penthouse diseñado para quienes exigen lo extraordinario.
            </p>
