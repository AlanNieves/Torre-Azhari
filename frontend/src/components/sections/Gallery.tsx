...
function GalleryItem({ image }: { image: typeof images[0] }) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-3xl border border-[#E8E2D5] bg-[#F5F1E8]/30 ${image.col}`}
    >
      <motion.div
        style={{ y }}
      ...
      <motion.div
        ...
        className="absolute bottom-4 left-4 flex items-center gap-2 rounded-full border border-[#E8E2D5] bg-white/90 px-3 py-1.5 backdrop-blur-sm"
      >
        <svg className="h-3.5 w-3.5 text-[#5C564F]" fill="currentColor" viewBox="0 0 24 24">
        ...
        <span className="text-xs font-medium text-[#2A2520]">@torreazhari</span>
      </motion.div>
    </motion.div>
  );
}
  ...
  return (
    <section className="mt-16 sm:mt-20 lg:mt-24">
      <div className="mx-auto max-w-[1400px] px-6 sm:px-10 lg:px-16">
        ...
        >
          <p className="text-xs font-semibold tracking-[0.18em] text-[#5C564F]">GALERÍA SOCIAL</p>
          ...
          {/* Social stats */}
          <div className="mt-8 grid grid-cols-3 gap-4 rounded-2xl border border-[#E8E2D5] bg-white/50 p-6 shadow-sm">
            <div>
              <p className="font-serif text-2xl text-[#2A2520]">12K</p>
              <p className="mt-1 text-xs text-[#5C564F]">Seguidores</p>
            </div>
            <div>
              <p className="font-serif text-2xl text-[#2A2520]">850</p>
              <p className="mt-1 text-xs text-[#5C564F]">Posts</p>
            </div>
            <div>
              <p className="font-serif text-2xl text-[#2A2520]">4.8</p>
              <p className="mt-1 text-xs text-[#5C564F]">Rating</p>
            </div>
          </div>
        </motion.div>
